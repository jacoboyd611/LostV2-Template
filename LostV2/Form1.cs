        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            switch (scene)
            {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    outputLabel.Text = $"After putting the panel back you turn around and face a horde of rats standing stock still. They cover the entire subway car and when you move to get away the horde pounces. Killing you with no witnesses.\n\nGame Over\n\nPlay Again?";
                    option1Label.Text = "Yes";
                    option2Label.Text = "No";
                    Refresh();
                    break;
                ...
                case 9:
                    ...
                    break;
                case 10:
                    outputLabel.Text = $"The horde backs off, almost absorbing your feeble attempt, but it buys you some time.\n\n You scan the cramped subway car for an escape. You have 2 options, break the window and jump out of a moving subway car, attempt to run to the next car in search of other people.\n\nWhich do you pick?";
                ...
                case 19:
                    ...
                    break;
                case 20:
                    outputLabel.Text = $"You turn left and follow the tunnel for what feels like hours. Eventually light hits your eyes and you come across a subway platform. A passerby helps you off the tracks and calls an ambulance.\n\nAt the hospital no one believes your story but they fix you up.After a few days you're released and back to normal. Though you vow never to take the subway again.\n\nGame Over\n\nPlay again?";
                    option1Label.Text = "Yes";
                    option2Label.Text = "No";
